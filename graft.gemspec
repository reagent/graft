...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "Rakefile", "lib/graft", "lib/graft/core_ext", "lib/graft/core_ext/hash.rb", "lib/graft/json", "lib/graft/json/attribute.rb", "lib/graft/json/model.rb", "lib/graft/json.rb", "lib/graft/model", "lib/graft/model.rb", "lib/graft/version.rb", "lib/graft/xml", "lib/graft/xml/attribute.rb", "lib/graft/xml/model.rb", "lib/graft/xml/type.rb", "lib/graft/xml.rb", "test/test_helper.rb", "test/unit", "test/unit/core_ext", "test/unit/core_ext/hash_test.rb", "test/unit/json", "test/unit/json/attribute_test.rb", "test/unit/json/model_test.rb", "test/unit/model", "test/unit/xml", "test/unit/xml/attribute_test.rb", "test/unit/xml/model_test.rb", "test/unit/xml/type_test.rb"]
